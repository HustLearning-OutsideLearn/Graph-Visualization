...
main_dir = "D:\Github\Graph-Visualization\Implementation\HustMap"
...
position_df = meta_df[["Pos_X", "Pos_Y"]] / 1000
...
nx.write_edgelist(G, path=main_dir + "/grid.edgelist", delimiter=":")
...
ax = plt.gca()
ax.margins(0.08)
xmin, xmax, ymin, ymax = plt.axis([-0.6, 12.9, 9.83, 0.63])
print(xmin, " ", xmax, " ", ymin, " ", ymax)
plt.tight_layout()
plt.savefig(main_dir + "/hustmap.png", format = 'png')
plt.show()